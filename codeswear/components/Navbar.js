...
const Navbar = ({cart,addToCart,removeFromCart,clearCart,subTotal}) => {
  ...
  return (
    <div className='flex flex-col py-4 sticky top-0 md:flex-row md:justify-start justify-center items-center my-0 shadow-xl bg-white z-10'>
      ...
      <Link href={"/"} passHref><a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
      ...
      <div  className="cart absolute right-0 top-2 mx-5 cursor-pointer flex ">
        <Link href={'/login'}><a> <MdAccountCircle  className=' text-xl md:text-3xl mx-4'/></a></Link>
