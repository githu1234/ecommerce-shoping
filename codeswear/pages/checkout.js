  ...
  return (
    <div className="container px-2 sm:m-auto">
      ...
      <div  className="sideCart bg-pink-100 p-6 m-2">
        ...
        <div className="mx-4">
        <Link href={'/order'}><a><button className=" cursor-pointer flex  mr-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm"><BsFillBagCheckFill className='m-1'/>Pay ₹{subTotal}</button>
            </a></Link>
        </div>
    </div>
  );
