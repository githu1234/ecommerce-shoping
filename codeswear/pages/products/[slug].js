...
const Post = ({addToCart}) => {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto  object-cover object-top rounded" src="https://m.media-amazon.com/images/I/61pdK+XF7QL._UX679_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button  onClick={()=>{addToCart(slug,1,499,'wear-the-code','xl','black')}} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
        ...
        {!service && service!=null && <div className='text-red-700 text-sm mt-3'>
          sorry! we cant delivery to this pincode
        </div>}
        { service && service!=null && <div className='text-red-700 text-sm mt-3'>
          yay! pincode is serviceability
        </div>}
      </div>
    </div>
  </div>
