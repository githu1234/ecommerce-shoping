...
export default function Home() {
  ...
  <div>
      <Head>
        ...
        <link rel="icon" href="/footer.jpg" />
      </Head>  
      <div className=" flex justify-center relative  rounded overflow-hidden ">
            <img alt="ecommerce" className=" w-full h-[50vh] block" src="/tshirt.jpg"/>
          </div>
      <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">wear with codeswear.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Whatever you want to wear</p>
    </div>
